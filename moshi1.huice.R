moshi1.huice<-function(id=SH000001.1D,DATABegt="1997-01-01",CSBegt="2013-05-08",CSEndt="2013-06-24")
{
  i<-1
  MS.ADVANTAGE<-0
  MS.DATE<-0
  while(i<=as.Date(CSEndt)-as.Date(CSBegt)+1)
  {
    ...
    MS.ADVANTAGE[i]<-moshi1(id,DATABegt,as.character(as.Date(CSBegt)+i-1));
    i<-i+1   
  }
  MS.HUICE<-list()
