moshi2<-function(id=SH000001.1D,Begt="1997-01-01",Endt="2013-06-19")
{
  ...
  if (WEEK=="星期五")  diejia<-1.0319
  if (WEEK=="星期一")  diejia<-1.0371
  if (WEEK=="星期二")  diejia<-1.1
  if (WEEK=="星期三")  diejia<-0.9679
  if (WEEK=="星期四")  diejia<-1.05
