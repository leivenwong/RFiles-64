rb.gaopinmoshi3.huice<-function(id=RB.60M,DATABegt="2010-05-04 10:00:00",CSBegt="2012-01-01 10:00:00",CSEndt="2013-07-29 15:00:00")
{
  MS.ADVANTAGE<-0
  MS.DATE<-CSBegt
  jishu<-1
  ...
  for(i in as.character(DATETIME))
  {
    ...
    MS.ADVANTAGE[jishu]<-rb.gaopinmoshi3(id,DATABegt,as.character(i));
