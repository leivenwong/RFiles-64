moshi21.shangpin.huice<-function(id=RU.1D,DATABegt="1997-01-01",CSBegt="2006-01-01",CSEndt="2013-06-24")
{
  jishu<-1
  MS.ADVANTAGE<-0
  MS.DATE<-0
  ...
  for(i in as.character(DATETIME))
  {
    ...
    MS.ADVANTAGE[jishu]<-moshi21.shangpin(id,DATABegt,as.character(i));
