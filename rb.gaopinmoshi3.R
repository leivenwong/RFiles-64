rb.gaopinmoshi3<-function(id=IF01.15M,Begt="2010-04-16 09:30:00",Endt="2013-06-24 15:00:00")
{
  ...
  if(SHIJIANDUAN=="10:00:00") diejia<-1.12359550561798
  if(SHIJIANDUAN=="11:00:00") diejia<-0.918781725888325
  if(SHIJIANDUAN=="14:00:00") diejia<-1.12957746478873
  if(SHIJIANDUAN=="15:00:00") diejia<-0.963636363636364
