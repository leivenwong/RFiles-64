gaopinmoshi1.huice<-function(id=IF01.15M,DATABegt="2010-04-16 9:00:00",CSBegt="2012-07-03 09:00:00",CSEndt="2013-07-3 15:15:00")
{
  MS.ADVANTAGE<-0
  MS.DATE<-CSBegt
  jishu<-1
  ...
  for(i in as.character(DATETIME))
  {
    ...
    MS.ADVANTAGE[jishu]<-gaopinmoshi1(id,DATABegt,as.character(i));
