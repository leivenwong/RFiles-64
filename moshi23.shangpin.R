moshi23.shangpin<-function(id=RU.1D,Begt="1997-01-01",Endt="2013-06-24")
{
  ...
  if (WEEK=="星期五")  diejia<-1.13
  if (WEEK=="星期一")  diejia<-1.0029
  if (WEEK=="星期二")  diejia<-1.0259
  if (WEEK=="星期三")  diejia<-0.9462
  if (WEEK=="星期四")  diejia<-1.27
