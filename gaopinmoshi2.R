gaopinmoshi2<-function(id=SH000001.60M,Begt="2003-03-12 9:00:00",Endt="2013-06-27 15:00:00")
{
  ...
  if (SHIJIANDUAN=="10:30:00")  diejia<-0.944611
  if (SHIJIANDUAN=="11:30:00")  diejia<-1.07012
  if (SHIJIANDUAN=="14:00:00")  diejia<-1.222412
  if (SHIJIANDUAN=="15:00:00")  diejia<-0.9117
