moshi4<-function(id=SH000001.1D,Begt="1997-01-01",Endt="2013-06-19")
{
  ...
  while(i<jishu)
  {
    if (NEXTMS[i]=="ZS" &  MS[i]==DANGTIANMS)  zs1<-zs1+1
    if (NEXTMS[i]=="ZT" &  MS[i]==DANGTIANMS)  zt1<-zt1+1
    if (NEXTMS[i]=="ZU" &  MS[i]==DANGTIANMS)  zu1<-zu1+1
    if (NEXTMS[i]=="ZV" &  MS[i]==DANGTIANMS)  zv1<-zv1+1
    if (NEXTMS[i]=="ZW" &  MS[i]==DANGTIANMS)  zw1<-zw1+1
    if (NEXTMS[i]=="ZX" &  MS[i]==DANGTIANMS)  zx1<-zx1+1
    if (NEXTMS[i]=="ZY" &  MS[i]==DANGTIANMS)  zy1<-zy1+1
    if (NEXTMS[i]=="ZZ" &  MS[i]==DANGTIANMS)  zz1<-zz1+1
  ...
  if (zs1+zt1+zu1+zv1+zw1+zx1+zy1+zz1+qa1+qb1+qc1+qd1+qe1+qf1+qg1+qh1+qs1+qt1+qu1+qv1+qw1+qx1+qy1+qz1+
        ra1+rb1+rc1+rd1+re1+rf1+rg1+rh1+rs1+rt1+ru1+rv1+rw1+rx1+ry1+rz1!=0)
    zonghe1<- zs1+zt1+zu1+zv1+zw1+zx1+zy1+zz1+qa1+qb1+qc1+qd1+qe1+qf1+qg1+qh1+qs1+qt1+qu1+qv1+qw1+qx1+qy1+qz1+
    ra1+rb1+rc1+rd1+re1+rf1+rg1+rh1+rs1+rt1+ru1+rv1+rw1+rx1+ry1+rz1
  if (zs1+zt1+zu1+zv1+zw1+zx1+zy1+zz1+qa1+qb1+qc1+qd1+qe1+qf1+qg1+qh1+qs1+qt1+qu1+qv1+qw1+qx1+qy1+qz1+
        ra1+rb1+rc1+rd1+re1+rf1+rg1+rh1+rs1+rt1+ru1+rv1+rw1+rx1+ry1+rz1==0)
    zonghe1<- 1
  
  if (WEEK=="星期五")  diejia<-1.1361
  if (WEEK=="星期一")  diejia<-1.1602
  if (WEEK=="星期二")  diejia<-1.1102
  if (WEEK=="星期三")  diejia<-0.8795
  if (WEEK=="星期四")  diejia<-1.2074
  
  if ((zs1+zt1+zu1+zv1+qa1+qb1+qc1+qd1+qs1+qt1+qu1+qv1
       +ra1+rb1+rc1+rd1+rs1+rt1+ru1+rv1)/zonghe1*100*diejia>100)
    jg<-100
  
  if ((zs1+zt1+zu1+zv1+qa1+qb1+qc1+qd1+qs1+qt1+qu1+qv1
       +ra1+rb1+rc1+rd1+rs1+rt1+ru1+rv1)/zonghe1*100*diejia<=100)
    jg<-(zs1+zt1+zu1+zv1+qa1+qb1+qc1+qd1+qs1+qt1+qu1+qv1
